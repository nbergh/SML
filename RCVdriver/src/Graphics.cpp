...
//	glutTimerFunc(1000.0/PARAMETERS::GRAPHICS_FRAME_RATE,updateFrame,0);
//
...
//	glPointSize(2.0);
//	glVertexPointer(3, GL_FLOAT, sizeof(LidarPointForGraphics), &thisPointer->lidarExportData.lidarPointsListForGraphics->x);
...
//	glVertexPointer(2,GL_FLOAT,sizeof(ObstaclePointForGraphics),&thisPointer->lidarExportData.obstaclePointListForGraphics->x);
//	glDrawArrays(GL_QUADS,0,4*thisPointer->lidarExportData.currentNrOfObstaclesForGraphics);
//
//	//Draw the paths:
//	glColor3f(0,0,1); // Set the color of the macroPath to blue
...
//	glColorPointer(3,GL_UNSIGNED_BYTE,sizeof(PathPointInLocalXY),&thisPointer->pathExportData.microPathXY->r);
